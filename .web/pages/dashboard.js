...
export default function Component() {
  ...
  <Link as={NextLink} href={`/`} sx={{"width": "100%"}}>
  <HStack sx={{"bg": isTrue((state.router.page.path === "/landing page") || (((state.router.page.path === "/") && "Landing page") === "Home")) ? `#F5EFFE` : `transparent`, "color": isTrue((state.router.page.path === "/landing page") || (((state.router.page.path === "/") && "Landing page") === "Home")) ? `#1A1060` : `black`, "borderRadius": "0.375rem", "boxShadow": "0px 0px 0px 1px rgba(84, 82, 95, 0.14)", "width": "100%", "paddingX": "1em"}}>
  <Image src={`/github.svg`} sx={{"height": "2.5em", "padding": "0.5em"}}/>
  <Text>
  {`Landing page`}
</Text>
